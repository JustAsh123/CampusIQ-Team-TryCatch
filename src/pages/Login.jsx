    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 dark:bg-surface-950 px-4 relative">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-surface-500 dark:text-surface-400 text-sm mt-1">Sign in to your CampusIQ account</p>
        </div>
        ...
        <div className="bg-white dark:bg-surface-850 rounded-2xl border border-surface-200 dark:border-surface-800 p-7 shadow-xl shadow-surface-900/5 dark:shadow-black/20">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-white dark:bg-surface-850 px-3 text-surface-400">or sign in with email</span>
            </div>
          </div>
